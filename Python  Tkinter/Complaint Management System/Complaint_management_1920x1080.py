...
class Complaint:
    def __init__(self,root):
        ...
        MainFrame = Frame(self.TabControl1,bd =10,width = 1530,height = 800,relief = RIDGE)
        MainFrame.grid()
        Tab2Frame = Frame(self.TabControl2,bd =10,width = 1530,height = 800,relief = RIDGE)
        Tab2Frame.grid()
        Tab3Frame = Frame(self.TabControl3,bd =10,width = 1350,height = 700,relief = RIDGE)
        Tab3Frame.grid()

        TopFrame1 = Frame(MainFrame,bd = 10,width = 1520,height = 100,relief = RIDGE)
        TopFrame1.grid()
        TopFrame2 = Frame(MainFrame,bd = 10,width = 1520,height = 100,relief = RIDGE)
        TopFrame2.grid()
        TopFrame3 = Frame(MainFrame,bd = 10,width = 1520,height = 100,relief = RIDGE)
        TopFrame3.grid()

        #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        UpperFrame = Frame(TopFrame2,bd = 5, width = 1510,height = 400,padx = 2,bg = 'cadetblue',relief = RIDGE)
        UpperFrame.grid()
        LowerFrame = Frame(TopFrame2,bd = 5,width = 1510,height = 800,padx = 2,relief = RIDGE)
        LowerFrame.grid()
        left_box = Frame(LowerFrame,bd = 5,width = 500,height = 200,padx = 2,bg = 'cadetblue',relief = RIDGE)
        left_box.pack(side = LEFT)
        right_box = Frame(LowerFrame,bd = 5,width = 1160,height = 200,padx = 2,bg = 'cadetblue',relief = RIDGE)
        right_box.pack(side = RIGHT)
        lower_chat_box = Frame(TopFrame3,bd = 5,width = 1505,height = 330,padx = 2,relief = RIDGE)
        lower_chat_box.pack()
        ...
        #++++++++++++++++++++++++++++++++++++++++++Title Name+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        self.lb1Title = Label(TopFrame1,font = ('arial',20,'bold'),text = '\tComplaint Management System\t',justify = CENTER)
        ...
        self.txtUserName = Entry(UpperFrame,font = ('arial',12,'bold'),bd = 5,width = 70 ,textvariable = Name    )
        self.txtUserName.grid(row = 0,column = 1)
        self.lb1Gender = Label(UpperFrame,font = ('arial',12,'bold'),text = 'Gender ',bd = 10)
        self.lb1Gender.grid(row =0,column = 2,sticky = W)
        self.cboGender = ttk.Combobox(UpperFrame,textvariable = Gender,state = 'readonly',font = ('arial',14,'bold'),width = 24)
        ...
        self.pincodetext = Entry(UpperFrame,font = ('arial',12,'bold'),bd = 5,width = 30,textvariable = pincode)
        ...
        self.Address_us = Entry(UpperFrame,font = ('arial',12,'bold'),bd = 5,width = 70,textvariable = Address)
        ...
        self.txtCity = Entry(UpperFrame,font = ('arial',12,'bold'),bd = 5,textvariable = City,width = 30)
        ...
        self.txtDistrict = Entry(UpperFrame,font = ('arial',12,'bold'),bd = 5,textvariable = District,width = 30)
        ...
        #row1
        self.ckTransport = Checkbutton(right_box,font = ('arial',15,'bold'),bg = 'cadetblue',width = 20,padx = 0,pady = 0, variable = var1 ,text = 'Transport')
        self.ckTransport.grid(row = 1,column = 0,padx = 10,pady = 10)
        self.ckWater = Checkbutton(right_box,font = ('arial',15,'bold'),bg = 'cadetblue',width = 21,padx = 0,pady = 0, variable = var2 ,text = 'Water')
        self.ckWater.grid(row = 1,column = 1)
        self.ckElectricity = Checkbutton(right_box,font = ('arial',15,'bold'),bg = 'cadetblue',width = 21,padx = 0,pady = 0, variable = var3 ,text = 'Electricity')
        self.ckElectricity.grid(row = 1,column = 2)
        self.ckRoad = Checkbutton(right_box,font = ('arial',15,'bold'),bg = 'cadetblue',width = 21,padx = 0,pady = 0, variable = var4 ,text = 'Road')
        self.ckRoad.grid(row = 1,column = 3)

        #row2
        self.ckservice = Checkbutton(right_box,font = ('arial',15,'bold'),bg = 'cadetblue',width = 20,padx = 0,pady = 0, variable = var5 ,text = 'Service')
        self.ckservice.grid(row = 2,column = 0,padx = 10,pady = 10)
        self.ckHospitals = Checkbutton(right_box,font = ('arial',15,'bold'),bg = 'cadetblue',width = 21,padx = 0,pady = 0, variable = var6 ,text = 'Hospitals')
        self.ckHospitals.grid(row = 2,column = 1)
        self.ckTax = Checkbutton(right_box,font = ('arial',15,'bold'),bg = 'cadetblue',width = 21,padx = 0,pady = 0, variable = var7 ,text = 'Tax')
        self.ckTax.grid(row = 2,column = 2)
        self.ckcommu = Checkbutton(right_box,font = ('arial',15,'bold'),bg = 'cadetblue',width = 21,padx = 0,pady = 0, variable = var8 ,text = 'Communication')
        self.ckcommu.grid(row = 2,column = 3)

        #row3
        self.ckEducation = Checkbutton(right_box,font = ('arial',15,'bold'),bg = 'cadetblue',width = 20 ,padx = 0,pady = 0, variable = var9 ,text = 'Education')
        self.ckEducation.grid(row = 3,column = 0,padx = 10,pady = 10)
        self.ckDrainage = Checkbutton(right_box,font = ('arial',15,'bold'),bg = 'cadetblue',width = 21,padx = 0,pady = 0, variable = var10 ,text = 'Drainage')
        self.ckDrainage.grid(row = 3,column = 1)
        self.ckgas = Checkbutton(right_box,font = ('arial',15,'bold'),bg = 'cadetblue',width = 21,padx = 0,pady = 0, variable = var11 ,text = 'Gas issue')
        self.ckgas.grid(row = 3,column = 2)
        self.ckOther = Checkbutton(right_box,font = ('arial',15,'bold'),bg = 'cadetblue',width = 21,padx = 0,pady = 0, variable = var12 ,text = 'Other')
        ...
        #+++++++++++++++++++++++++++++++++++++++++chat Box++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        self.chatcomment = Label(lower_chat_box,bd = 10,font =  ('arial',15,'bold'),text = 'Note/Comment/Suggestion :-\t\t\t\t\t\t\t\t\t\t\t\t\t',justify = LEFT)
        self.chatcomment.grid(row = 0,column = 0)
        self.lb1Note = Text(lower_chat_box,bd = 10,font = ('arial',12,'bold'),width = 165,height = 14,relief = RIDGE)
        ...
        TopFrame11 = Frame(Tab2Frame,bd = 10,width = 1520,height = 100,relief = RIDGE)
        TopFrame11.grid(row = 0,column = 0)
        TopFrame12 = Frame(Tab2Frame,bd = 10,width = 1520,height = 650,relief = RIDGE)
        ...
        self.complaintdatarecords.column('Complaint_type',width = 200)
